...
export default function IOModal({
  ...
  const PlaygroundTitle =
    playgroundPage && ENABLE_PUBLISH && flowName ? flowName : "Run Bot";
              ...
              >
                ...
                {sidebarOpen && showPublishOptions && (
                  <div className="absolute bottom-2 left-0 flex w-full flex-col gap-8 border-t border-border px-2 py-4 transition-all">
                    ...
                    >
                      <BotbusinessLogo className="me-2 h-5 w-6 dark:invert" />
                      <div className="text-sm">Built with Botbusiness</div>
                    </Button>
                  </div>
                )}
              </div>
            ...
            {!sidebarOpen && showPublishOptions && (
              <div className="absolute bottom-6 left-4 hidden transition-all md:block">
                <ShadTooltip
                  styleClasses="z-50"
                  side="right"
                  content="Built with Botbusiness"
                >
                  <Button
                    variant="primary"
                    ...
                    onClick={LangflowButtonClick}
                  >
                    <BotbusinessLogo className="h-[18px] w-[18px] scale-150 dark:invert" />
                  </Button>
                </ShadTooltip>
              </div>
            )}
